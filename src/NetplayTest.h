...
private:
    ...
    static nlohmann::json buildPeerReport(PeerState& peer)
    {
        ...
        return {
            ...
            {"confirmedReplayScheduledCount", predictionStats.confirmedReplayScheduledCount},
            {"predictionMismatchRollbackScheduledCount", predictionStats.predictionMismatchRollbackScheduledCount},
    ...
    static nlohmann::json buildRuntimePeerReport(PeerT& peer)
    {
        ...
        return {
            ...
            {"confirmedReplayScheduledCount", snapshot.predictionStats.confirmedReplayScheduledCount},
            {"predictionMismatchRollbackScheduledCount", snapshot.predictionStats.predictionMismatchRollbackScheduledCount},
