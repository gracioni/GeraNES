                                                                         ...
                                                                         uint32_t emulationFrame)
{
    ...
    const bool remoteInputRecovery = coordinator.hasRemoteInputRecoveryParticipant();
    const uint32_t recoveryPlayableThroughFrame =
        m_lastProduceHadLocalSlots ? m_producedThroughFrame : queueHorizonFrame;
    const uint32_t playableThroughFrame =
        remoteInputRecovery
            ? recoveryPlayableThroughFrame
