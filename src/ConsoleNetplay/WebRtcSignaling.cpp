...
bool WebRtcSignalingConfig::valid() const
{
...
nlohmann::json WebRtcSignalingRoomInfo::toJson() const
{
    return {
        {"roomId", roomId},
...
std::optional<WebRtcSignalingRoomInfo> WebRtcSignalingRoomInfo::fromJson(const nlohmann::json& json)
{
...
nlohmann::json WebRtcSignalingMessage::toJson() const
{
    nlohmann::json json = {
        {"version", version},
...
std::string WebRtcSignalingMessage::toText() const
{
    return toJson().dump();
}

std::optional<WebRtcSignalingMessage> WebRtcSignalingMessage::fromJson(const nlohmann::json& json)
{
    if(!json.is_object()) return std::nullopt;
...
std::optional<WebRtcSignalingMessage> WebRtcSignalingMessage::fromText(const std::string& text)
{
    try {
