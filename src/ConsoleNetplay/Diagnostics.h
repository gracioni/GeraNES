...
struct RollbackStats
{
    ...
    uint32_t confirmedReplayScheduledCount = 0;
    uint32_t predictionMismatchRollbackScheduledCount = 0;
    ...
    void recordConfirmedReplayScheduled(FrameNumber frame, PlayerSlot slot);
    void recordPredictionMismatchRollbackScheduled(FrameNumber frame, PlayerSlot slot);
