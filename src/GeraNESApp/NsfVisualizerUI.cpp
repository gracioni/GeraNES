#include "GeraNESApp/NsfVisualizerUI.h"
...
float NsfVisualizerUI::clamp01(float value)
{
    return std::clamp(value, 0.0f, 1.0f);
}

float NsfVisualizerUI::smoothTowardsFixedStep(float current, float target)
{
...
float NsfVisualizerUI::binMagnitude(const float* spectrum, int bin)
{
...
NsfVisualizerUI::NsfVisualizerUI()
{
...
void NsfVisualizerUI::draw(const std::vector<float>& samples, int sampleRate, int topMargin, int viewportWidth, int viewportHeight,
