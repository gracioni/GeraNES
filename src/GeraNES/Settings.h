...
public:
    ...
    enum class Device { CONTROLLER, ZAPPER, ARKANOID_CONTROLLER, BANDAI_HYPERSHOT, SNES_MOUSE, SNES_CONTROLLER, POWER_PAD_SIDE_A, POWER_PAD_SIDE_B, FAMICOM_CONTROLLER, SUBOR_MOUSE, NONE };
