...
public:
    ...
    enum class Device { CONTROLLER, ZAPPER, ARKANOID_CONTROLLER, BANDAI_HYPERSHOT, SNES_MOUSE, SNES_CONTROLLER, POWER_PAD_SIDE_A, POWER_PAD_SIDE_B, FAMICOM_CONTROLLER };
    enum class ExpansionDevice { NONE, STANDARD_CONTROLLER_FAMICOM, BANDAI_HYPERSHOT, KONAMI_HYPERSHOT, ARKANOID_CONTROLLER, FAMILY_TRAINER_SIDE_A, FAMILY_TRAINER_SIDE_B };
