...
public:
    Mapper214(ICartridgeData& cd) : BaseMapper(cd)
    {
    ...
    GERANES_HOT void writePrg(int addr, uint8_t /*data*/) override
    {
        ...
        m_chrBank = static_cast<uint8_t>(absolute & 0x0003) & m_chrMask;
        m_prgBank = static_cast<uint8_t>((absolute >> 2) & 0x03) & m_prgMask;
    }
