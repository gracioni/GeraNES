...
public:
    ...
    {
        numberOfPRG16kBanks  = m_cd.numberOfPRGBanks<W16K>();
    ...
    GERANES_HOT uint8_t readPrg(int addr) override
    {
        ...
        if(addr < 0x4000) return m_cd.readPrg<W16K>(m_PRGReg,addr);
        return m_cd.readPrg<W16K>(numberOfPRG16kBanks-1,addr);
    }
